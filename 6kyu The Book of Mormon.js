...
function Mormons(startingNumber, reach, target, missionsCount=0){
  
    //base case if starting number greater than target return count
    if (startingNumber >= target){ return missionsCount }
    
    //recursive increase starting number and counter
    return Mormons(startingNumber + startingNumber*reach, reach, target, missionsCount + 1)
